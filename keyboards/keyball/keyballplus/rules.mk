# MCU name（下のCONVERT_TOで上書きされるが、参考として残す）
MCU = atmega32u4

# Bootloader selection（下のCONVERT_TOで上書きされる）
BOOTLOADER = caterina

# SparkFun Pro Micro RP2040へ変換してビルドする
# MCU/BOOTLOADER/SPIピン等はQMKのコンバーター定義（sparkfun_pm2040）が自動的に上書きする
